    ...
    >
      <div>
        ...
        <div class="productOne">
          ...
          <div class="info">
            <div class="priceone">¥{{ productone.productone.shop_price }}</div>
            <div class="number">
    ...
    <transition name="bounce2">
      <div class="sku" v-show="showBase">
        ...
        <div class="goods-center border-bottom">
          ...
          <div class="bottom" @click="addCart" v-if="!flag">添加到购物车</div>
